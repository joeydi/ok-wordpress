...
var $=$||jQuery,OK=OK||{};OK.init_mobile_nav=function(){var t=$("#menu-trigger"),o=$("nav");t.click(function(){o.toggleClass("active")})},OK.init_clock=function(){if(!$("body").hasClass("home"))return!1;var t=$("#content"),o=$('<div class="clock-container"></div>'),i=$('<img src="/wp-content/themes/ok/static/images/clock-outline.svg" alt="" />'),e=$('<img src="/wp-content/themes/ok/static/images/clock-minute-hand.svg" alt="" />'),n=$('<img src="/wp-content/themes/ok/static/images/clock-hour-hand.svg" alt="" />');t.addClass("js-clock"),o.append(i,e,n),t.append(o),$(window).scroll(function(){var t=$(window).scrollTop();e.css({transform:"rotate("+t+"deg)"}),n.css({transform:"rotate("+t/30+"deg)"})})},OK.show_testimonial=function(t){"down"==t?$(this).addClass("show"):$(this).removeClass("show")},OK.init_testimonials=function(){if(!$("body").hasClass("home"))return!1;$("#hero").addClass("active"),$(".testimonial").waypoint({offset:"100%",continuous:!0,handler:OK.show_testimonial})},OK.show_project_excerpt=function(t){"down"==t?$(this).addClass("show"):$(this).removeClass("show")},OK.init_project_archive=function(){if(!$("body").hasClass("post-type-archive-project"))return!1;$(".project-excerpt").waypoint({offset:"100%",continuous:!0,handler:OK.show_project_excerpt})},OK.init_project=function(){var t=$(".project-images");t.imagesLoaded(function(){t.isotope({itemSelector:"div",layoutMode:"masonry"})}),t.magnificPopup({delegate:"a",type:"image",image:{verticalFit:!1},gallery:{enabled:!0,preload:[1,2],navigateByImgClick:!0},zoom:{enabled:!0}}),$(window).load(function(){$("#project-pagination").waypoint({offset:"100%",continuous:!0,handler:function(){$(this).addClass("show")}})})},OK.init_video_post=function(){$(".video").fitVids()},$(document).ready(function(){OK.init_mobile_nav(),OK.init_clock(),OK.init_testimonials(),OK.init_project_archive(),OK.init_project(),OK.init_video_post()});