...
* Released under the WTFPL license - http://sam.zoy.org/wtfpl/
*/
var $=$||jQuery,OK=OK||{};OK.init_clock=function(){if(!$("body").hasClass("home")){return false}var e=$("#content"),d=$('<div class="clock-container"></div>'),c=$('<img src="/app/themes/ok/images/clock-outline.svg" />'),b=$('<img src="/app/themes/ok/images/clock-minute-hand.svg" />'),a=$('<img src="/app/themes/ok/images/clock-hour-hand.svg" />');e.addClass("js-clock");d.append(c,b,a);e.append(d);$(window).scroll(function(){var f=$(window).scrollTop();b.css({transform:"rotate("+f+"deg)"});a.css({transform:"rotate("+f/30+"deg)"})})};OK.show_testimonial=function(a){if(a=="down"){$(this).addClass("show")}else{$(this).removeClass("show")}};OK.init_testimonials=function(){if(!$("body").hasClass("home")){return false}$(".testimonial").waypoint({offset:"100%",continuous:true,handler:OK.show_testimonial})};OK.show_project_excerpt=function(a){if(a=="down"){$(this).addClass("show")}else{$(this).removeClass("show")}};OK.init_project_archive=function(){if(!$("body").hasClass("post-type-archive-project")){return false}$(".project-excerpt").waypoint({offset:"100%",continuous:true,handler:OK.show_project_excerpt})};OK.init_project=function(){var a=$(".project-images");a.imagesLoaded(function(){a.isotope({itemSelector:"div",layoutMode:"masonry"})});a.magnificPopup({delegate:"a",type:"image",image:{verticalFit:false},gallery:{enabled:true,preload:[1,2],navigateByImgClick:true,},zoom:{enabled:true,}});$("#project-pagination").waypoint({offset:"100%",continuous:true,handler:function(){$(this).addClass("show")}})};OK.init_video_post=function(){$(".video").fitVids()};$(document).ready(function(){OK.init_clock();OK.init_testimonials();OK.init_project_archive();OK.init_project();OK.init_video_post()});